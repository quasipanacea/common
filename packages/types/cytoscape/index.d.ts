...
declare module 'cytoscape' {
	...
	namespace cytoscape {
		...
		interface CoreEvents {
			...
			bind<K extends keyof EventMap>(event: K, handler: EventMap[K]): this
			...
			listen<K extends keyof EventMap>(event: K, handler: EventMap[K]): this
			listen(
				events: EventNames,
				selector: Selector,
				handler: EventHandler,
			 ...
			 * @param handler The handler function that is called when one of the specified events occurs.
			 */
			one<K extends keyof EventMap>(event: K, handler: EventMap[K]): this
			/**
			 * Bind to events that occur in the graph, and trigger the handler only once.
			 *
			 * @param events A space separated list of event names.
			...
			unbind<K extends keyof EventMap>(event: K, handler?: EventMap[K]): this
			unbind(
				events: EventNames,
				selector: Selector,
				handler?: EventHandler,
			...
			unlisten<K extends keyof EventMap>(event: K, handler?: EventMap[K]): this
			unlisten(
				events: EventNames,
				selector: Selector,
				handler?: EventHandler,
		...
		interface EventMap
			extends UserInputDeviceEventMap,
				UserInputDeviceHighEventMap,
				CollectionEventMap,
				GraphEventMap,
				ExtensionEventMap {}
		...
		interface AbstractEventObject {
			...
			type: keyof UserInputDeviceEventMap | keyof UserInputDeviceHighEventMap
		 ...
		 */
		interface UserInputDeviceEventMap {
		...
		/**
		 * This interface is for extensions to add their own events
		 */
		...
		/**
		 * This interface is for extensions to add their own layouts
		 */
		...
		interface LayoutEventMap extends EventMap {}
